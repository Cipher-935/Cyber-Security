#include <windows.h>
#include <stdio.h>
#pragma comment(lib, "user32.lib")  // For functions like GetMessage, DispatchMessage, etc.
#pragma comment(lib, "kernel32.lib") // For general Windows API functions (though often included by default)
...
BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpReserved) {
    ...
    case DLL_PROCESS_ATTACH:
        ...
        fopen_s(&file, "C:\\Users\\jay\\Desktop\\dll_injection_test.txt", "a");
        if (file == NULL) {
            return FALSE;
        }
